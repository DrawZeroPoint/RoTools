...
class ControlServer {
 ...
 private:
   ...
   * @return
   */
  bool buildTrajectory(MoveGroupInterface& move_group,
  ...
  void updateTrajectoryStamp(trajectory_msgs::JointTrajectory traj_in,
                             double stamp,
  ...
  std::vector<control_msgs::JointTolerance> buildTolerance(int group_id,
                                                           double position,
                                                           double velocity,
                                                           double acceleration);
  ...
  void getMirroredTrajectory(MoveGroupInterface& move_group,
                             trajectory_msgs::JointTrajectory trajectory,
