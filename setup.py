...
d["packages"] = [
    ...
    "rotools.hpp",
    "rotools.hpp.core",
    "rotools.hpp.manipulation",
    "rotools.moveit",
    "rotools.moveit.core",
    "rotools.policy",
    "rotools.policy.rmp_flow",
    "rotools.robot",
    "rotools.robot.serial",
    "rotools.sensing",
    "rotools.sensing.core",
    "rotools.simulation",
    "rotools.simulation.mujoco",
    "rotools.snapshot",
    "rotools.snapshot.core",
    "rotools.utility",
    "rotools.websocket",
    "rotools.websocket.core",
    "rotools.xsens",
    "rotools.xsens.core",
]
d["package_dir"] = {"": "src"}
