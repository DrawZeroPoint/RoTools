...
ControlServer::ControlServer(ros::NodeHandle& nh, ros::NodeHandle& pnh) : nh_(nh), pnh_(pnh) {
  ...
  execute_all_poses_srv_ = nh_.advertiseService("execute_all_poses", &ControlServer::executeAllPosesSrvCb, this);
...
void ControlServer::updateTrajectoryStamp(trajectory_msgs::JointTrajectory traj_in,
                                          double stamp,
...
void ControlServer::buildControllerGoal(int group_id,
