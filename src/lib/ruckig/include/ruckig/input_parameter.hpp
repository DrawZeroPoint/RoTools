...
enum class Synchronization {
  ...
  // PhaseOnly, ///< Always phase synchronize the DoFs (even when this is not time-optimal), else returns
  // "ErrorNoPhaseSynchronization"
...
class InputParameter {
 ...
 public:
  ...
  std::optional<std::vector<Vector<double>>> per_section_max_velocity, per_section_max_acceleration,
  ...
  bool operator!=(const InputParameter<DOFs>& rhs) const {
    return (current_position != rhs.current_position || current_velocity != rhs.current_velocity ||
            current_acceleration != rhs.current_acceleration || target_position != rhs.target_position ||
            target_velocity != rhs.target_velocity || target_acceleration != rhs.target_acceleration ||
            max_velocity != rhs.max_velocity || max_acceleration != rhs.max_acceleration || max_jerk != rhs.max_jerk ||
            ...
            per_section_min_acceleration != rhs.per_section_min_acceleration || max_position != rhs.max_position ||
            min_position != rhs.min_position || enabled != rhs.enabled || minimum_duration != rhs.minimum_duration ||
            min_velocity != rhs.min_velocity || min_acceleration != rhs.min_acceleration ||
            control_interface != rhs.control_interface || synchronization != rhs.synchronization ||
