...
class PositionStep1 {
  ...
  void time_all_vel(Profile& profile,
                    double vMax,
                    double vMin,
                    double aMax,
                    double aMin,
  ...
  void time_acc0_acc1(Profile& profile,
                      double vMax,
                      double vMin,
                      double aMax,
                      double aMin,
                      double jMax,
                      bool return_after_found);
  void time_all_none_acc0_acc1(Profile& profile,
                               double vMax,
                               double vMin,
                               double aMax,
                               double aMin,
 ...
 public:
  explicit PositionStep1(double p0,
                         double v0,
                         double a0,
                         double pf,
                         double vf,
...
class PositionStep2 {
 ...
 public:
  explicit PositionStep2(double tf,
                         double p0,
                         double v0,
                         double a0,
                         double pf,
