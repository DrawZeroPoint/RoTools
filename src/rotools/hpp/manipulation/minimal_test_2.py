...
class HPPManipulationInterface(object):
    ...
    def __init__(
        ...
        print('Using path planner {}, available planners are: {}'.format(
    ...
    def _make_plan(self):
        ...
        print("Current configuration:\n{}".format(["{0:0.8f}".format(i) for i in self._q_init]))
    ...
    def make_test_plan(self):
        ...
        self._q_goal = [0.97013911, 0.21839769, 0.70710678, 0.70710678, 0.00011383, 0.00000100, 0.00027770, 1.00063293,
                        ...
                        0.04000000, -1.00249611, 0.80319770, 0.49647833,
                        -1.97797381, 0.00062338, 2.50150087, -0.00001964, 0.04000000, 0.03622407, -2.40000000,
