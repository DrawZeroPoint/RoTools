...
if __name__ == "__main__":
    ...
    if sys.version_info >= (3, 2):
        ...
        rospy.logwarn(
            "You need to manually run 'hppcorbaserver' before launching this program"
        )
    ...
    try:
        ...
        if configs["enable_viewer"]:
            if sys.version_info >= (3, 2):
                ...
                rospy.logwarn(
                    "You need to manually run 'gepetto-gui -c basic' before launching this program"
                )
